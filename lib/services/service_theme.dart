...
class ThemeService extends ValueNotifier<ThemeData> {
  ...
  ThemeData theme = (customThemeFromColorScheme(
      darkColorScheme, GoogleFonts.robotoTextTheme(), true));

  ThemeService()
      : super(customThemeFromColorScheme(
            lightColorScheme, GoogleFonts.robotoTextTheme()));

  void switchLightAndDarkTheme(int number) {
    print(number);
    theme = (number % 2) == 0
        ? customThemeFromColorScheme(darkColorScheme,
